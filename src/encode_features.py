...
print("Text columns: ", Category_columns)
...
preprocess = ColumnTransformer(transformers=[("category", OneHotEncoder(handle_unknown="ignore"), Category_columns), ("numbers", "passthrough", numeric_columns),], remainder="drop")
